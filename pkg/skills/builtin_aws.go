...
func AWSSkills() []*core.Skill {
	return []*core.Skill{
		...
		{
			Name:        "aws.eks.deploy",
			Description: "Deploy an application to Amazon EKS with managed node group settings",
			Provider:    core.ProviderAWS,
			...
			Inputs: []core.SkillInput{
				...
				{Name: "node_instance_type", Type: "string", Required: false, Description: "Managed node group instance type", Default: "m6i.large"},
				{Name: "min_nodes", Type: "int", Required: false, Description: "Minimum node count", Default: "2"},
				{Name: "max_nodes", Type: "int", Required: false, Description: "Maximum node count", Default: "6"},
				{Name: "region", Type: "string", Required: false, Description: "AWS region", Default: "us-east-1"},
			},
			Outputs: []core.SkillOutput{
				{Name: "rollout_status", Type: "string", Description: "Deployment rollout status"},
				{Name: "cluster_endpoint", Type: "string", Description: "EKS API endpoint"},
			},
			RiskLevel:            core.RiskHigh,
			RequiresConfirmation: true,
			Execution: core.ExecutionConfig{
				Type:    core.ExecCLI,
				Command: "aws eks update-kubeconfig && kubectl apply -f deployment.yaml && kubectl rollout status",
				Timeout: 300 * time.Second,
			},
			Rollback: core.RollbackConfig{Supported: true, Procedure: "kubectl rollout undo deployment/{name} -n {namespace}"},
		},
		{
			Name:        "aws.ec2.deploy.cpu_optimized",
			Description: "Launch or update EC2 workloads using compute-optimized instance classes",
			Provider:    core.ProviderAWS,
			Category:    core.CategoryDeployment,
			Inputs: []core.SkillInput{
				{Name: "name", Type: "string", Required: true, Description: "Workload or instance name"},
				{Name: "instance_type", Type: "string", Required: false, Description: "Compute-optimized instance type", Default: "c7i.large"},
				{Name: "ami_id", Type: "string", Required: false, Description: "AMI ID to launch"},
				{Name: "subnet_id", Type: "string", Required: false, Description: "Private subnet ID"},
			...
			Outputs: []core.SkillOutput{
				...
				{Name: "instance_type", Type: "string", Description: "Resolved compute-optimized instance type"},
			},
			RiskLevel:            core.RiskMedium,
			RequiresConfirmation: true,
			Execution: core.ExecutionConfig{
				Type:    core.ExecCLI,
				Command: "aws ec2 run-instances --instance-type",
				Timeout: 120 * time.Second,
			},
			Rollback: core.RollbackConfig{Supported: true, Procedure: "Terminate launched instance via aws ec2 terminate-instances"},
		},
		{
			Name:        "aws.rds.launch.secure",
			Description: "Launch an RDS instance with encryption, private networking, backups, and deletion protection",
			Provider:    core.ProviderAWS,
			Category:    core.CategoryDeployment,
			Inputs: []core.SkillInput{
				{Name: "db_identifier", Type: "string", Required: true, Description: "RDS DB instance identifier"},
				{Name: "engine", Type: "string", Required: false, Description: "Database engine", Default: "postgres"},
				{Name: "instance_class", Type: "string", Required: false, Description: "RDS instance class", Default: "db.m6i.large"},
				{Name: "storage_encrypted", Type: "bool", Required: false, Description: "Enable encryption at rest", Default: "true"},
				{Name: "publicly_accessible", Type: "bool", Required: false, Description: "Expose instance publicly", Default: "false"},
				{Name: "backup_retention_days", Type: "int", Required: false, Description: "Automated backup retention period", Default: "7"},
				{Name: "deletion_protection", Type: "bool", Required: false, Description: "Protect instance from accidental deletion", Default: "true"},
				{Name: "region", Type: "string", Required: false, Description: "AWS region", Default: "us-east-1"},
			},
			Outputs: []core.SkillOutput{
				{Name: "db_instance_arn", Type: "string", Description: "Created RDS instance ARN"},
				{Name: "endpoint", Type: "string", Description: "RDS endpoint"},
			},
			RiskLevel:            core.RiskHigh,
			RequiresConfirmation: true,
			Execution: core.ExecutionConfig{
				Type:    core.ExecCLI,
				Command: "aws rds create-db-instance --storage-encrypted --no-publicly-accessible --deletion-protection",
				Timeout: 600 * time.Second,
			},
			Rollback: core.RollbackConfig{Supported: true, Procedure: "Delete DB instance with snapshot if rollback is approved"},
		},
		{
			Name:        "aws.service.deploy",
			Description: "Deploy an AWS service workload using a service name and deployment profile",
			Provider:    core.ProviderAWS,
			Category:    core.CategoryDeployment,
			Inputs: []core.SkillInput{
				{Name: "service", Type: "string", Required: true, Description: "AWS service name (ec2, eks, rds, lambda, ecs, etc.)"},
			...
			Outputs: []core.SkillOutput{
				{Name: "service", Type: "string", Description: "Resolved AWS service"},
			...
			Execution: core.ExecutionConfig{
				Type:    core.ExecCLI,
				Command: "aws <service> <deploy-command>",
				Timeout: 300 * time.Second,
			},
